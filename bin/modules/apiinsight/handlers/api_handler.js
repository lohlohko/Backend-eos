const { GetTable } = require('../../bgquery/handlers/api_handler');
const queryModel = require('../../bgquery/repositories/queries/query_model');
...
const LLM_URL = config.get('/llm/LLM_URL');
